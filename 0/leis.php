    ...
    <div class="v_main">
       ...
       <div class="mainCon" id="zoom">
           <div class="mainContect clearfix">
                <?=$ini->fenleis(20,12,15,15,1,'没有检索到相关信息...','
                <div class="leis_cc">
                    <a class="img_a" href="[url]"><img src="[tu]" alt="[biaoti]"></a>
                    <div class="img_div">
                       <p class="img_div_p">
                          <a href="[url]">[biaoti]</a><kbd>[shijian]</kbd>
                       </p>
                       <p class="txt_div_p">[zhengwen]...</p>
                       <a class="txt_a" href="[url]">[阅读全文]</a>
                    </div>
                </div>
                ',140)?>
           </div><!-- end mainContect-->
